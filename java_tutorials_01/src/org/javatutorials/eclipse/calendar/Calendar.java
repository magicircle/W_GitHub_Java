...
class Cal_day{
	...
	public static int week_11(int year){
		try{
			final int year_o= 1583;
		...
		catch(Exception Week_11){
			System.out.println("오류가 발생했습니다 : "+Week_11.getMessage());
		} 
